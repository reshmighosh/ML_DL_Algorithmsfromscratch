...
class DecisionTreeClassifier:
    ...
    in segments that reduce the Gini Index or Cross Entropy. 
    ...
    considered, and the predictor and cutpoint is chosen that reduces the Gini Impurity or
    Cross Entropy the most.
    ...
    Instead of global metric that the loss function in a Decision Tree Classifer
    is trained on local metric like Gini Impurity or Information Gain
    ...
    ``Algorithm:
        ...
        3. Use k-fold CV to choose alpha - divide train datasets on k folds:
            ...
            3.2. Avg the mse for each value of alpha and choose alpha to reduce Gini Impurity
